function song = PaintItBlack(octave, speed, rate)
...
% Theme
song =[note(q,r,4) ...
    (note(q,E,4) + note(q,A,4))/2 ...
    (note(q,E,4) + note(q,B,4))/2 ...
    (note(q,E,4) + note(q,A,4) + note(q,C,5))/3 ...
    (note(q,E,4) + note(q,A,4) + note(q,D,5))/3 ...
    (note(q,E,4) + note(q,A,4) + note(q,C,5))/3 ...
    (note(q,E,4) + note(q,B,4))/2 ...
    (note(q,E,4) + note(q,A,4))/2 ...
    (note(q,B,3) + note(q,E,4) + note(q,A,4))/3 ...
    (note(q,B,3) + note(q,E,4) + note(q,Gs,4))/3 ...
    (note(q,B,3) + note(q,E,4) + note(q,A,4))/3 ...
    (note(q,B,3) + note(q,E,4) + note(q,B,4))/3 ...
    (note(q,B,3) + note(q,E,4) + note(q,A,4))/3 ...
    (note(h+q,B,3) + note(h+q,E,4) + note(h+q,Gs,4))/3 ...
    note(q,r,4) ...
    (note(q,E,4) + note(q,A,4))/2 ...
    (note(q,E,4) + note(q,B,4))/2 ...
    (note(q,E,4) + note(q,A,4) + note(q,C,5))/3 ...
    ...
    (note(h+q,B,3) + note(h+q,E,4) + note(h+q,Gs,4))/3 ...
    note(q,r,4) ...
    (note(q,C,5) + note(q,E,5) + note(q,A,5))/3 ...
    (note(q,B,4) + note(q,D,5) + note(q,G,5))/3 ...
    (note(q,B,4) + note(q,D,5) + note(q,G,5))/3 ...
    (note(q,E,4) + note(q,G,4) + note(q,C,5))/3 ...
    (note(e,E,4) + note(e,G,4) + note(e,C,5))/3 ...
    (note(e+q,G,4) + note(e+q,B,4) + note(e+q,D,5))/3 ...
    (note(q,G,4) + note(q,B,4) + note(q,D,5))/3 ...
    (note(q,A,4) + note(q,C,5) + note(q,E,5))/3 ...
    (note(q,A,4) + note(q,C,5) + note(q,E,5))/3 ...
    (note(e,A,4) + note(e,C,5) + note(e,E,5))/3 ...
    (note(e,A,4) + note(e,D,5))/2 ...
    (note(e,A,4) + note(e,C,5))/2 ...
    (note(e+w,A,4) + note(e+w,C,5) + note(e+w,E,5))/3 ...
    note(q,r,4) ...
    (note(q,C,5) + note(q,E,5) + note(q,A,5))/3 ...
    (note(q,B,4) + note(q,D,5) + note(q,G,5))/3 ...
    (note(q,B,4) + note(q,D,5) + note(q,G,5))/3 ...
    ...
    (note(e+q,G,4) + note(e+q,B,4) + note(e+q,D,5))/3 ...
    (note(q,G,4) + note(q,B,4) + note(q,D,5))/3 ...
    (note(q,Fs,4) + note(q,A,4) + note(q,E,5))/3 ...
    (note(q,Fs,4) + note(q,A,4) + note(q,E,5))/3 ...    
    (note(q,Fs,4) + note(q,A,4) + note(q,D,5))/3 ...
    (note(e,Fs,4) + note(e,A,4) + note(e,C,5))/3 ...
    (note(e+w,Gs,4) + note(w+e,B,4) + note(e+w,E,5))/3 ...
