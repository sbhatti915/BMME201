function song = Siren(octave, speed, rate)
% Siren -- simulates siren
...
% Creates siren sound
cresc=linspace(0.2,1,rate*barLength);  % crescendo (get louder)
dim=linspace(1,0.2,rate*barLength);    % diminuendo (get softer)
oneSiren=note(w*2,A,4).*[cresc dim]; 	% one cycle of siren
song=repmat(oneSiren,1,5);        	% repeats it 5 times
